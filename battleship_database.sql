...
DROP DATABASE IF EXISTS battleship_database;
...
CREATE TABLE games (
    ...
    end_time DATETIME,                        -- End time of the game
...
VALUES
    ...
    (1, 2, 100, 80, '2024-10-10 14:00:00', '2024-10-10 15:00:00'),  -- manel007 gana 100, Hugo 80
    -- Partida 2: Laura456 vs Esther789
    (3, 4, 60, 90, '2024-10-11 14:00:00', '2024-10-11 15:00:00'),   -- Esther gana 90, Laura 60
    -- Partida 3: Hugo123 vs User1
    (2, 5, 50, 90, '2024-10-12 14:00:00', '2024-10-12 15:00:00'),   -- User1 gana 90, Hugo 50
    -- Partida 4: User2 vs manel007
    (6, 1, 60, 50, '2024-10-13 14:00:00', '2024-10-13 15:00:00'),   -- User2 gana 60, manel007 50
    -- Partida 5: Laura456 vs User1
    (3, 5, 70, 70, '2024-10-14 14:00:00', '2024-10-14 15:00:00'),   -- Empate, ambos obtienen 70
    -- Partida 6: Esther789 vs Hugo123
    (4, 2, 0, 50, '2024-10-15 14:00:00', '2024-10-15 15:00:00'),    -- Hugo gana 50, Esther 0
    -- Partida 7: User2 vs Laura456
    (6, 3, 60, 50, '2024-10-16 14:00:00', '2024-10-16 15:00:00'),   -- User2 gana 60, Laura 50
    -- Partida 8: manel007 vs Esther789
    (1, 4, 0, 60, '2024-10-17 14:00:00', '2024-10-17 15:00:00'),    -- Esther gana 60, manel007 0
    -- Partida 9: User1 vs User2
    (5, 6, 80, 0, '2024-10-18 14:00:00', '2024-10-18 15:00:00'),    -- User1 gana 80, User2 0
    -- Partida 10: Hugo123 vs Laura456
    (2, 3, 0, 50, '2024-10-19 14:00:00', '2024-10-19 15:00:00');    -- Laura gana 50, Hugo 0
